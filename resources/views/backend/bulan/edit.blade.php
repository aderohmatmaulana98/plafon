...
<div class="row">
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{  route('bulan.editBulan', $bulan->id)  }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="id" value="{{ $bulan->id }}" hidden>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="nama_bulan">Nama bulan</label>
                                <input type="text" class="form-control" id="nama_bulan" name="nama_bulan"
                                    placeholder="Masukan Nama Bulan" value="{{ $bulan->nama_bulan }}" required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <br>
