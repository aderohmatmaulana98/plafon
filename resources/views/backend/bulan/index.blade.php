...
@section('content')
    <div class="card table-responsive">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/bulan/add" type="button" class="btn rounded-pill btn-primary justify-content-end"
            ...
            <table id="datatable" class="table table-striped ">
                ...
                <tbody>
                    ...
                    @foreach ($bulan as $a)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td width="auto">{{ $a->nama_bulan }}</td>
                            <td>
                                {{-- <a href="/posts_/{{ $a->id }}" type="button" class="btn btn-primary"
                                    target="_blank">Live</a> --}}
                                <a href="/bulan/edit/{{ $a->id }}" type="button" class="btn btn-success">Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Anda yakin ingin menghapus {{ $a->nama_bulan }}</p>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="{{  route('bulan.deleteBulan', $a->id)  }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
