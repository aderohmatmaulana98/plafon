...
@section('content')
    <div class="card table-responsive">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/penjab/add" type="button" class="btn rounded-pill btn-primary justify-content-end"
                    ...
                    @foreach ($penjab as $a)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/penjab/edit/{{ $a->id }}" type="button" class="btn btn-success">Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Anda yakin ingin menghapus {{ $a->nama_penjab }}</p>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="{{  route('penjab.deletePenjab', $a->id)  }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
