    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{  route('distributor.editDistributor', $distributor->id)  }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_bulan" name="nama_bulan"
                                        placeholder="Masukan Nama Bulan" value="{{ $distributor->nama_bulan }}" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <br>
