                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                                    placeholder="Masukan Nama Barang" value="{{ $barang->nama_barang }}" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jenis" name="jenis"
                                    placeholder="Masukan Jenis" value="{{ $barang->jenis }}" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="harga" name="harga"
                                    placeholder="Masukan Harga" value="{{ $barang->harga }}" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ukuran" name="ukuran"
                                    placeholder="Masukan Ukuran" value="{{ $barang->ukuran }}" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" name="image" placeholder="Thumbnail"
                                    required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <textarea name="deskripsi" cols="100" rows="10" required>{{ $barang->deskripsi }}</textarea>
                        </div>
