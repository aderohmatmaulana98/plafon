...
@section('content')
    <div class="card table-responsive  shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/role/add" type="button" class="btn rounded-pill btn-primary justify-content-end"
            ...
            <table id="datatable" class="table table-striped">
                ...
                <tbody>
                    ...
                    @foreach ($role as $a)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td width="auto">{{ $a->role }}</td>
                            <td>
                                {{-- <a href="/posts_/{{ $a->id }}" type="button" class="btn btn-primary"
                                    target="_blank">Live</a> --}}
                                <a href="/role/edit/{{ $a->id }}" type="button" class="btn btn-success">Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Anda yakin ingin menghapus {{ $a->role }}</p>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="{{  route('role.deleteRole', $a->id)  }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
